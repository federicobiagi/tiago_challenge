...
// Add obj table in pose 0.4 0.0 0.5
  ...
  obstacle_pose.pose.position.x = 0.5;  //1.025600
  obstacle_pose.pose.position.y = 0.109529;
  obstacle_pose.pose.position.z = 0.53;
  ...
  planning_scene_publisher_->publish(planning_scene_msg);
    ...
    double z_target = table_height;
    double block_height = 0.015;
    double block_spacing = 0.025; //space between blocks in the same layer
    double gripper_height = 0.27;
